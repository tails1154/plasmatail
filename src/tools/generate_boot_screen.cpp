/*
 *	Copyright (c) 2008-2011, Plasmatail, Inc. All rights reserved.
...
//! Plasmatail boot splash image generator/converter
...
main(int argc, char* argv[])
{
	...
	fputs("// This file was generated by the generate_boot_screen Plasmatail build "
		"tool.\n\n", sOutput);
